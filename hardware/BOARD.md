...
- DC/RST/BL — три соседних пина SV1 (PA4/PB9/PB8, SV1.5/SV1.4/SV1.3). SV5 в разводке TFT не
  используется. PA4/PB9 здесь подписаны как DAC_OUT1/RPM2, но в прошивке не заняты.
