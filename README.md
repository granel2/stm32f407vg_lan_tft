...
Коротко: SPI3 (PC10/PC11/PC12, 10 МГц) + CS/DC/RST/BL на PA15/PD6/PD5/PC7, всего 2 разъёма
(SV4 + SV1). При старте `TFT_App_SmokeTest()` печатает в USART1 `[tft] RDID4(0xD3) = …`
(ожидается `xx 00 77 96`), заливает экран R/G/B и рисует тест-паттерн, затем показывает
